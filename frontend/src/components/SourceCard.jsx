...
import { Youtube, FileVideo, Music, FileText, Layers, Image as ImageIcon, ArrowRight, Loader2, ShieldCheck } from 'lucide-react'
...
export default function SourceCard({ source }) {
  ...
  return (
    <div className="card p-5 flex flex-col gap-3 hover:shadow-md hover:border-primary-200 transition-all">
